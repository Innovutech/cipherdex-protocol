...
const ALLOWED_TARGETS = new Map([
  ...
  ["scripts/deploy-public-testnet.ts", {
    arguments: ["--network", "cotiTestnet"],
    funded: true,
    deploymentRecordSlug: "coti-testnet-public",
    environment: [
      "COTI_DEPLOYMENT_RECORD",
      "CIPHERDEX_FEE_BENEFICIARY",
  ...
  ["scripts/deploy-public-mainnet.ts", {
    arguments: ["--network", "cotiMainnet"],
    funded: true,
    signerMode: "mainnet",
    chainId: 2_632_500,
    ...
    networkEnvironment: ["COTI_MAINNET_RPC_URL"],
    fundedNetworkEnvironment: ["COTI_MAINNET_GAS_LIMIT"],
    deploymentRecordSlug: "coti-mainnet-public",
    environment: [
      "COTI_DEPLOYMENT_RECORD",
      "CIPHERDEX_FEE_BENEFICIARY",
      "CIPHERDEX_EXISTING_WRAPPED_NATIVE",
  ...
  ["scripts/mainnet-public-preflight.ts", {
    arguments: ["--network", "cotiMainnet"],
    funded: true,
    signerMode: "mainnet",
    chainId: 2_632_500,
  ...
  ["scripts/testnet-best-execution.ts", {
    ...
    environment: [
      ...
      "CIPHERDEX_CONFIGURED_COMPATIBILITY_PROOF",
  ...
  ["scripts/deploy-observable-confidential-mainnet.ts", {
    arguments: ["--network", "cotiMainnet"],
    funded: true,
    signerMode: "mainnet",
    chainId: 2_632_500,
    ...
    networkEnvironment: ["COTI_MAINNET_RPC_URL"],
    fundedNetworkEnvironment: ["COTI_MAINNET_GAS_LIMIT"],
    deploymentRecordSlug: "coti-mainnet-observable-confidential",
    environment: [
      "COTI_DEPLOYMENT_RECORD",
      "CIPHERDEX_FEE_BENEFICIARY",
  ...
  ["scripts/testnet-observable-confidential.ts", {
    arguments: ["--network", "cotiTestnet"],
    funded: true,
    environment: [
      "COTI_AES_KEY",
  ...
  ["scripts/testnet-private-it-packing-probe.ts", {
    arguments: ["--network", "cotiTestnet"],
    funded: true,
    environment: [
      "COTI_AES_KEY",
  ...
  ["scripts/testnet-launchpad.ts", {
    ...
    environment: [
      ...
      "COTI_FACTORY",
      "COTI_FEE_VAULT",
      "CIPHERDEX_CONFIGURED_LAUNCHPAD_PROOF",
