...
/**
 * @title ObservableConfidentialLaunchpadMigrator
 ...
 */
contract ObservableConfidentialLaunchpadMigrator is
    IObservableConfidentialLaunchpadMigrator
{
    ...
    bytes32 private constant EIP712_NAME_HASH =
        keccak256("CipherDEX Observable Launchpad Migrator");
    bytes32 private constant EIP712_VERSION_HASH = keccak256("1");
    bytes32 public constant MIGRATION_TYPEHASH = keccak256(
        "Migration(bytes32 launchId,address initializationStrategy,address creator,address tokenA,address tokenB,uint8 decimalsA,uint8 decimalsB,uint256 feeBps,uint256 initialPriceReferenceX18,bytes32 encryptedInputsHash,uint64 deadline,bool withDisposition,uint8 disposition,uint64 unlockTime)"
    );
    ...
    function _migrate(
        ...
        (pool, ) = IObservableConfidentialInitializationStrategy(
            ...
            .prepareLaunch(
                ...
                request.decimalsB,
                request.feeBps,
                request.initialPriceReferenceX18,
                request.deadline,
                authorizationHash
            );
        ...
        IObservableConfidentialCPMMFactory factoryContract =
        ...
        IObservableConfidentialCPMM canonicalPool =
